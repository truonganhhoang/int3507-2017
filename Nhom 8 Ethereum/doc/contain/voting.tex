...
\begin{itemize}
\item phiên bản nodejs >= 6.0.0
\item phiên bản npm >= 3.0.0
\item phiên bản geth >= 1.7.0
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../img/new}
\caption{Thêm tài khoản}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../img/import}
\caption{Nhập tài khoản}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../img/app}
\caption{Ứng dụng bầu cử}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../img/transaction}
\caption{Hình ảnh trang cung cấp tra cứu giao dịch}
\end{figure}
