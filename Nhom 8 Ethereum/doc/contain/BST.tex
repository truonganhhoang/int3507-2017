...
\begin{itemize}
<<<<<<< HEAD
	\item \textbf{nonce}: Giá trị vô hướng bằng số lượng các giao dịch được gửi từ địa chỉ này hoặc, trong trường hợp tài khoản có mã liên quan, số lượng hợp đồng tạo ra bởi tài khoản này. Đối với địa chỉ một trong trạng thái $\sigma$, điều này sẽ được biểu hiện chính thức $\sigma[a]_n$.
	\item \textbf{balance}: Một giá trị vô hướng bằng số Wei sở hữu bởi chính địa chỉ đó. Định nghĩa là $\sigma[a]_n$.
...
=======
	\item \textbf{nonce}: Giá trị vô hướng bằng số lượng các giao dịch được gửi từ địa chỉ này hoặc, trong trường hợp tài khoản có mã liên quan, số lượng hợp đồng tạo ra bởi tài khoản này. Đối với địa chỉ một trong trạng thái $\sigma$, điều này sẽ được ký hiệu là $\sigma[a]_n$.
...
>>>>>>> def36e16064263f420952a642076894b325d17c7
\end{itemize}
