...
Trong trường hợp $B_R[n]_u$, chúng ta sử dụng cách tiếp cận tương tự để xác định mỗi mục như là khí được sử dụng để đánh giá giao dịch tương ứng được tổng kết với mục trước đó (hoặc không, nếu nó là lần đầu tiên), cho chúng ta một tổng số hoạt động:
