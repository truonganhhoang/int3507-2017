...
\begin{figure}[ht]
	...
	\caption{Danh sách các hoạt động trong Ethereum Virtual Code và giá của nó (tính theo Gas)}
	\label{fig:gasprice}
\end{figure}
...
\subsubsection{Ứng dụng phân phối}
Ứng dụng phân phối (Decentralized App, viết tắt là DApp) là ứng dụng mã nguồn mở hoàn chỉnh, hoạt động độc lập, không có thực thể nào kiểm soát phần lớn các tokens của ứng dụng này. Dữ liệu và hồ sơ hoạt động của ứng dụng phải được lưu trữ dưới dạng mã hoá công khai, phân quyền chuỗi khối.
